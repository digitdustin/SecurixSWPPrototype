...
import SecurixLogo from '../assets/img/SecurixCircledLogo.svg'
...
const navigation = [
  { name: 'Modules', href: '#', current: true, navigation: modulesNavigation },
  { name: 'Project', href: '#', current: false, navigation: projectsNavigation },
